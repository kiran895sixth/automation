...
//project purpose : TC07 Check if the "Active Directory" users are listed properly in "List of Prolaborate Users" page or not


public class TC07_verify_ADuser_added_properly extends BaseClass {
	...
	public void add_ADuser() throws InterruptedException, IOException {
		...
		WebElement signin = driver.findElement(By.xpath("//button[@class='btn w-100 sign-in-sso-btn']"));
...
//		driver.findElement(By.id("headerLogo")).click();
		...
		{
			System.out.println("ADuser added in user management users list");
			XLdata.pass(path, sheet2, 7, 2);
		} 
		else 
		{
			System.out.println("ADuser NOT added in user management users list");
			XLdata.pass(path, sheet2, 7, 2);
		}
	}
}
